...
%%
% Load data
df = readmatrix("./milkCounts.csv");
taxonomy = readmatrix("./newTaxonomy_milk.csv", FileType="text", OutputType="string");
sampleInfo = readmatrix("./milk_sampleMeta.csv", FileType="text", OutputType="string");

sampleInfo2 = readmatrix("./milk_sampleInfo_w_Anthropometrics.csv", FileType="text", OutputType="string");
%sampleInfo2 = readmatrix("./20240906_data/milk_asv_meta.csv", OutputType="string");
